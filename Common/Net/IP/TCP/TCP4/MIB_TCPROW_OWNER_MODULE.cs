...
public struct MIB_TCPROW_OWNER_MODULE : IConnectionOwnerInfo
{
    ...
    public Owner? OwnerModule => TCPHelper.GetOwningModuleInternal(NativeMethods.GetOwnerModuleFromTcpEntry, this);
    ...
    {
        return new MIB_TCPROW() { dwLocalAddr = _localAddr, dwRemoteAddr = _remoteAddr, dwLocalPort = _localPort, dwRemotePort = _remotePort, State = _state };
    }
}
