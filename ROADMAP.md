...
- :heavy_check_mark: [Summer 2020] Migrate WFN to .Net Core 3.1
...
- :heavy_check_mark: [Aug. 2020] Create (or move) issues / stories
...
- :construction: [Dec. 2020] Fix bugs
...
- :construction: [Mar. 2021] Add new features

  Pretty self explanatory.
 
- :heavy_check_mark: [No ETA] Update the application design

  Design is getting old, I guess a bit of a redesign would help attract new users.
  
- [No ETA] (Re)apply accessibility rules

- [No ETA] Add translations back as they've been partly lost (and add new ones)

**Initial statement (dec. 2019):** Now, why mentioning a long term roadmap (one full year is indeed a long term one)? Only because I know that we all have personal constraints and that while I would like to deal with all this ASAP, I won't be able to.
...
**Updated statement (jan. 2021):** The new version has a lot of breaking changes, and will need your feedback to improve, but a lot has been done already... and the initial roadmap has been followed (well... almost!).
